...
export default function Footer(){
  ...
  const data =[
    ...
    {title:'产品中心',link:'/product',list:[
      ...
      {text:'铝板',link:'/product/lvban'},
      {text:'铝棒',link:'/product/lvbang'},
      {text:'铝卷',link:'/product/lvjuan'},
      {text:'铝管',link:'/product/lvguan'},
      {text:'铝型材',link:'/product/lvxingcai'},
      {text:'铝锻件',link:'/product/lvduanjian'},
    ]},
