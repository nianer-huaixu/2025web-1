...
export default function Mark7A09(){
  const store = useStore()

  const suf = '7A09'
  const data = {
    ghzt:'T6,T651,T6511,H112,O',
    ...
    hxcf:[suf,'LC9','0.50','0.50','1.2-2.0','0.15','2.0-3.0','0.16-0.30','5.1-6.1','0.10','——','——','0.05','0.15','余量'],
    dxyt:[
      '7A09航空超硬铝合金, 强度高，耐磨性好。',
      '7A09主要用于制造飞机结构及其他要求强度高，抗腐蚀性能的高应力结构件，如飞机上，下翼面壁板，桁条等．固溶处理后塑性好，热处理强化效果好，在150度以下有良好的强度，并且有特别好的低温强度，焊接性能差，有应力腐蚀开裂倾向．还广泛应用于模具加工，机械设备，工装夹具、航天航空工业、吹塑（瓶）模、超声波塑焊模具、高尔夫球头、鞋模、纸塑模、发泡成型模、脱腊模、机械设备、用于制作高端铝合金自行车车架。在2014年将首次作为智能手机OPPO N3的机身材质被使用。'
    ]
  }
  return <>
    <Banner suf={suf}/>
