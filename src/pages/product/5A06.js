...
export default function Mark5A06(){
  ...
  const data = {
    ...
    hxcf:[suf,'LF6','0.40','0.40','0.10','0.5-0.8','5.8-6.8','——','0.20','0.02-0.10','——','——','0.05','0.15','余量'],
    dxyt:[
      '5A06高镁合金，耐蚀性好，焊接性优良，具有中等强度。',
      '5A06是高镁合金,在不可热处理合金中强度良好，耐蚀性、可切削性良好。阳极化处理后表面美观。电弧焊性能良好。5A06合金中的主要合金元素为镁，具有良好的抗蚀性与可焊接性能，以及中等强度。',
      '5A06属于Al-Mg系合金,使用范围广泛,特别是建筑业离不开此合金，是最有前途的合金。耐蚀性好，焊接性优良，冷加工性较好，并具有中等强度。AL-MG系合金，是应用最广的一种防锈铝，这种合金的强度高，特别是具有抗疲劳强度：塑性与耐腐蚀性高，不能热处理强化，，在半冷作硬化时塑性尚好，冷作硬化时塑性低，耐腐蚀好，焊接性良好，可切削性能不良，可抛光。用途主要用于要求高的可塑性和良好的焊接性，在液体或气体介质中工作的低载荷零件，如油箱，汽油或润滑油导管，各种液体容器和其他用深拉制作的小负荷零件：线材用来做铆钉。',
      '优良的抗腐蚀性能使5A06合金广泛用途如航空航天，军工以及汽车、飞机焊接件、地铁轻轨，需严格防火的压力容器（如液体罐车、冷藏车、冷藏集装箱）、制冷装置、电视塔、钻探设备、交通运输设备、导弹零件、工装夹具、装甲等。'
    ]
  }
  return <>
    <Banner suf={suf}/>
