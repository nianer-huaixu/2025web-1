...
export default function MarkLD2(){
  ...
  const data = {
    ...
    hxcf:['6A02','LD2','0.5-1.2','0.50','0.2-0.6','或Cr0.15-0.35','0.45-0.9','——','0.20','0.15','——','——','0.05','0.10','余量'],
    dxyt:[
      'LD2是一种铝合金材料，具有中等强度，退火和热态下有高的可塑性、淬火和自然时效后塑性尚可，且这种状态下抗蚀性可与5A02.3A21相比，人工时效状态合金具有晶间腐蚀倾向,可切削淬火后尚可，退火后不好，合金可点焊和氢原子焊，气焊。',
      'LD2铝合金是一种高强度铝合金，主要用于航空航天、军事装备、交通运输和工业应用等领域‌。其优异的机械性能和高强度特性使其在多个领域中得到了广泛应用。',
      'LD2铝合金的主要用途包括以下几个方面‌：',
