...
export default function About(){
  ...
  const data6 =[
    ...
    {text1:'以人为本',text2:'企业以人为本，员工以厂为荣，以人才和技术为基础，创造最佳产品服务。以客户为中心，持续满足客户需求，绝不失信于客户，为客户提供更加丰富、更具价值的方案和综合服务。'},
    {text1:'核心价值观',text2:'我们秉持精品、严谨、认真、实事求是的行事风格，脚踏实地，追求实实在在的成效。以客户为中心，绝不失信于任何人，以我的说到做到感染他人，赢得尊重。'},
    {text1:'可持续发展',text2:'公司坚持绿色智造路线，走可持续发展道路，践行“绿色智造”经营理念，通过提高材料、能源利用率、推广清洁能源、设备环保设施改造，主动承担企业应有的社会责任。'},
  ...
  return (
    ...
    <section className={styles.about4wrap}>
      ...
      <img src={store.common.url +'about/bg-3.webp'}/>
    </section>
